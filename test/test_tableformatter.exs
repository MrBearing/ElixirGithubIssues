defmodule Issues.TableFormatterTest do
  ...
  alias Issues.TableFormatterT, as: TF
  ...
  def simple_test_data do
    [ [c1: "r1 c1", c2: "r1 c2" ,c3: "r1 c3", c4: "r1+++c4"],
      ...
      [c1: "r3 c1", c2: "r3 c2", c3: "r3 c3", c4: "r2 c4"],
  ...
  def split_with_three_columns,do: TF.split_as_columns(simple_test_data,headers)

  test "split_as_columns_tests" do
  ...
  test "Output is correct" do
    result = capture_io fn ->
      TF.print_table_for_column(simple_test_data,headers)
    end
    assert result == """
    c1    | c2     | c3    | c4
    ------+--------+-------+--------
